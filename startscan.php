...
<h2>Check In</h2>
	...
	<form action ="startscan.php" action="POST">
	Barcode Number: <input type="field" name="barcode" onkeypress="javascript:return isNumber(event)" onmouseover="this.focus()"; autofocus /> <br /><br />
